...
@api_page.route("/api/users", methods=["GET"])
def get_user():
...
@api_page.route("/api/user/<user_name>", methods=["GET"])
...
@api_page.route("/api/offered-books", methods=["GET"])
def get_offer():
...
@api_page.route("/api/offered-book/<isbn>", methods=["GET"])
...
@api_page.route("/api/offered-book/<user_name>", methods=["GET"])
...
@api_page.route("/api/requested-books", methods=["GET"])
def get_request():
...
@api_page.route("/api/requested-book/<isbn>", methods=["GET"])
...
@api_page.route("/api/requested-book/<user_name>", methods=["GET"])
...
@api_page.route("/api/reported-books", methods=["GET"])
def get_report():
...
@api_page.route("/api/reported-book/<book_id>", methods=["GET"])
...
@api_page.route("/api/reported-book/<user_name>", methods=["GET"])
...
@api_page.route("/api/reviews/<isbn>", methods=["GET"])
...
@api_page.route("/api/reviews/<user_name>", methods=["GET"])
...
@api_page.route("/api/meeting/<meeting_id>", methods=["GET"])
...
@api_page.route("/api/works", methods=["GET"])
def get_work():
...
@api_page.route("/api/work/<isbn>", methods=["GET"])
...
@api_page.route("/api/books", methods=["GET"])
def get_book():
...
@api_page.route("/api/book/<isbn>", methods=["GET"])
def book_detail_isbn(isbn):
    book = Book.query.get(isbn)
    return book_schema.jsonify(book)

# endpoint to get book detail by exact title
@api_page.route("/api/book/title/<title>", methods=["GET"])
...
@app.route("/api/book/delete-book/isbn", methods=["DELETE"])
...
@api_page.route("/api/books/sorted-title", methods=["GET"])
def sort_book_title():
